...
const students = {
  left: 'https://pomilioblumm.eu/img/summer-school-maastricht-photo-01.png',
  right: 'https://images.squarespace-cdn.com/content/v1/5e8dbed8f63ed7113b233a97/1599939772176-50G0TD0Y1T3L4W57GP5W/mockup-of-a-female-student-wearing-a-heathered-oversized-hoodie-39170-r-el2.png'
};
...
<main id="top"><section class="hero"><div class="curve curve-left"></div><div class="curve curve-right"></div><div class="hero-dot dot-a"></div><div class="hero-dot dot-b"></div><div class="hero-head"><span class="batch-pill">OUR UPCOMING COURSE BATCH</span><h1>BATCH STARTING<br><span>${calendarIcon} SEP 10<sup>th</sup>, 2026</span></h1><div class="date-rule"></div><p>Kickstart your career in two high-demand fields<br>with industry-ready foundational skills.</p></div>
<div class="hero-grid"><div class="student-panel left-student"><div class="student-circle blue-circle"></div><img src="${students.left}" alt="College student with laptop and backpack"/></div>
...
<div class="student-panel right-student"><div class="student-circle purple-circle"></div><img src="${students.right}" alt="College student with laptop and backpack"/></div></div>
